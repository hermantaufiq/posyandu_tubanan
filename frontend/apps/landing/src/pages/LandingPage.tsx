        ...
        <section id="portal" className="bg-slate-50 py-12 border-t border-slate-200/60 relative z-20">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto">
              <a href="https://masyarakat-9f8qkckqp-hermans-projects-13e372e0.vercel.app" target="_blank" rel="noopener noreferrer" className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all group flex flex-col items-center text-center">
